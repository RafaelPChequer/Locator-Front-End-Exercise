...
idade.addEventListener('keyup', () => {
  if(idade.value.length > 2){
    ...
    labelIdade.innerHTML = 'Idade *Insira idade de 0 a 99'
    idade.setAttribute('style', 'border-color: red')
    validIdade = false
  } else {
    labelIdade.setAttribute('style', 'color: green')
    labelIdade.innerHTML = 'Usuário'
    idade.setAttribute('style', 'border-color: green')
    validIdade = true
  }
  if(idade.value < 18){
    labelIdade.setAttribute('style', 'color: orange')
    labelIdade.innerHTML = 'Idade *Usuario menor de idade'
    idade.setAttribute('style', 'border-color: orange')
    validIdade = true
  }
})
